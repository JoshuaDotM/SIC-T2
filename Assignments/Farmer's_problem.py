...
tomato_revenue = (
    tomato_acres_1 * tomato_yield_1 +
    tomato_acres_2 * tomato_yield_2
) * tomato_price_per_ton
...
Therefore we should not add them to the chemical free yield at 11 months.
'''